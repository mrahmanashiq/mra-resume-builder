<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h3 class="text-lg font-semibold text-gray-900">Academic Service</h3>
    ...
    <div v-if="resumeStore.service.length === 0"
      ...
      <h3 class="text-lg font-medium text-gray-900 mb-2">No service added</h3>
      <p class="text-gray-600 mb-4">Add reviewing, area chair roles, and committee work</p>
