<template>
  <div class="space-y-6">
      ...
      <div v-for="(p, index) in resumeStore.publications" :key="p.id"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Award</label>
          ...
          <div class="md:col-span-2">
            <label class="block text-sm font-medium text-gray-700 mb-2">Summary (optional, shown on the Portfolio style)</label>
    ...
    <div v-if="resumeStore.publications.length === 0"
      ...
      <h3 class="text-lg font-medium text-gray-900 mb-2">No publications added</h3>
      <p class="text-gray-600 mb-4">Add papers, preprints, and articles for your academic CV</p>
