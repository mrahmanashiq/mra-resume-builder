  ...
  <div class="space-y-8">
    ...
    <section>
      <div class="flex items-center justify-between mb-3">
        <h3 class="text-lg font-semibold text-gray-900">Accomplishments</h3>
      ...
      <div class="space-y-2">
        ...
        <p v-if="!resumeStore.accomplishments.length" class="text-sm text-gray-500">No accomplishments yet.</p>
      </div>
    </section>
    ...
    <section>
      <div class="flex items-center justify-between mb-3">
        <h3 class="text-lg font-semibold text-gray-900">Extra-Curricular Activities</h3>
      ...
      <div class="space-y-2">
        ...
        <p v-if="!resumeStore.extracurricular.length" class="text-sm text-gray-500">No activities yet.</p>
      </div>
    </section>

    <!-- Declaration -->
    <section class="pt-2 border-t border-gray-200">
      <h3 class="text-lg font-semibold text-gray-900 mb-3">Declaration</h3>
      ...
      <div class="grid grid-cols-2 gap-4 mt-3">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">Place (optional)</label>
