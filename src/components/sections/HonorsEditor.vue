<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h3 class="text-lg font-semibold text-gray-900">Honors & Awards</h3>
    ...
    <div v-if="resumeStore.awards.length === 0"
      ...
      <StarIcon class="w-12 h-12 text-gray-400 mx-auto mb-4" />
      <h3 class="text-lg font-medium text-gray-900 mb-2">No awards added</h3>
      <p class="text-gray-600 mb-4">Add honors, awards, fellowships, and nominations</p>
