<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h3 class="text-lg font-semibold text-gray-900">Invited Talks</h3>
    ...
    <div class="space-y-6">
      <div v-for="(t, index) in resumeStore.talks" :key="t.id"
        ...
        <div class="flex items-start justify-between mb-4">
          <h4 class="font-medium text-gray-900">Talk {{ index + 1 }}</h4>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Event / Host</label>
    ...
    <div v-if="resumeStore.talks.length === 0"
      ...
      <MicrophoneIcon class="w-12 h-12 text-gray-400 mx-auto mb-4" />
      <h3 class="text-lg font-medium text-gray-900 mb-2">No talks added</h3>
      <p class="text-gray-600 mb-4">Add invited talks, keynotes, and guest lectures</p>
