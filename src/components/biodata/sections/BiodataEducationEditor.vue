<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h3 class="text-lg font-semibold text-gray-900 dark:text-slate-100">Educational Qualification</h3>
    ...
    <div class="space-y-6">
      <div v-for="(row, index) in biodataStore.education"
        ...
        <div class="mb-4">
          <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Degree / Exam</label>
          <input type="text"
                 :value="row.degree"
        ...
        <div class="mt-4">
          <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Result / GPA</label>
          <input type="text"
                 :value="row.result"
    ...
    <div v-if="biodataStore.education.length === 0"
      ...
      <h3 class="text-lg font-medium text-gray-900 dark:text-slate-100 mb-2">No qualifications added</h3>
      <p class="text-gray-600 dark:text-slate-400 mb-4">Add your educational background</p>
