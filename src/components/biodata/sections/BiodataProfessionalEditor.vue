<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <h3 class="text-lg font-semibold text-gray-900 dark:text-slate-100">Professional Details</h3>
    ...
    <div class="space-y-6">
      <div v-for="(exp, index) in biodataStore.professional.experiences"
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Company / Organization</label>
            <input type="text"
                   :value="exp.company"
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Designation</label>
            <input type="text"
                   :value="exp.position"
          ...
          <label class="flex items-center space-x-2 text-sm text-gray-700 dark:text-slate-300">
            <input type="checkbox"
                   :checked="exp.current"
    ...
    <div v-if="biodataStore.professional.experiences.length === 0"
      ...
      <h3 class="text-lg font-medium text-gray-900 dark:text-slate-100 mb-2">No experience added</h3>
      <p class="text-gray-600 dark:text-slate-400 mb-4">Add your work experience</p>
      <button @click="addExperience" class="btn-primary">Add Experience</button>
    </div>

    <div class="pt-2">
      <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-2">Monthly Income</label>
      <input type="text"
